...
| Staff ID Cards | `/staff-id-cards` | **Working** (added 3 September 2026 — automatic staff identification card per active employee; generate / issue / edit / reissue / revoke / restore; `employee.idcard.manage` / `employee.idcard.viewAll`) |
...
(DATE)` heading rather than rewriting the body. **Sixty-five** 27 August – 3 September
