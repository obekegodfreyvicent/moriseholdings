...
spec, not built; that subsidiary's organisation is seeded in MBMS. **24**
...
(DATE)` heading rather than rewriting the body. **Seventy-two** 27 August – 3 September
2026 changes are recorded that way across docs 01–18 and `morise.docx`
(docs 19–23 carry one-line addenda but no full status log):
