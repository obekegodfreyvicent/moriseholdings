...
(DATE)` heading rather than rewriting the body. **Seventy-five** 27 August – 9 September
2026 changes are recorded that way across docs 01–18 and `morise.docx`
(docs 19–22 and 24 carry two one-line addenda each, doc 23 carries four
full/mixed addenda, doc 25 carries one full addendum, but none of docs
19–25 carries the full status log):
