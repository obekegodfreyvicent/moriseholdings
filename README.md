...
subsidiary-system spec, not built; only that subsidiary's organisation
(company, five field offices, twelve departments, six starter policies) is
seeded in MBMS. The
...
(DATE)` heading rather than rewriting the body. **Seventy-four** 27 August – 9 September
2026 changes are recorded that way across docs 01–18 and `morise.docx`
(docs 19–22 and 24 carry one-line addenda, doc 23 carries three full/mixed
addenda, but none of docs 19–25 carries the full status log):
